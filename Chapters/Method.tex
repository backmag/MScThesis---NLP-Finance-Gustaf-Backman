...
\textcolor{red}{Is this relevant? }\marginpar{Yes it is, but usually, you do not write this in the introduction. You should move it somewhere in the text, where you describe your experiments. In addition, the computing power is relevant only with computing time information. Many people have it nonetheless, even in scientific papers (It does not harm)}
