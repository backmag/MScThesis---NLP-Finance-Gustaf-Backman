...
\theabstract{
\marginpar{You need to have one or two sentences of intro before describing your contribution}In this thesis, I have evaluated the predictive power of financial news headlines on the movement of financial indices. More specifically, I tried to determine if I could improve a traditional time series model by adding news data. In my experiments, I used text representations of different complexities, from TF-IDF to recent transformer models, such as BERT and Sentence-BERT and, as targets, the S\&P 500 and US treasury rates with one and three years maturity. 
